...
//            String path = "http://"+ConfigUtil.get("SERVERIP")+":"+ConfigUtil.get("SERVERPORT")+""+ConfigUtil.get("PROJECT")+"/";
          //  String path = ConfigUtil.get("filePath");
            ...
            String urlPath="";
            if(url.getPort()!=-1){
                urlPath= url.getProtocol()+":"+"//"+url.getHost()+":"+url.getPort()+"/upload/"+"apk-version/"+apkInfo.getUrl();
            }else{
                urlPath=  url.getProtocol()+":"+"//"+url.getHost()+"/upload/"+"apk-version/"+apkInfo.getUrl();
            }
           // String apkPath = "http://"+req.getLocalAddr()+":"+req.getLocalPort()+"/upload/"+"apk-version/"+apkInfo.getUrl();
