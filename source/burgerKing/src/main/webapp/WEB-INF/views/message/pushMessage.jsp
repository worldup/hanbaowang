...
<script type="text/javascript">
	...
	$(function(){
		 $.ajax({
				async:false,
				url : basePath + "/message/getUserTreeList",//请求的action路径
				data:{
					"role":2
				},
				cache : false,
...
<script type="text/javascript">	
	...
	$("#btn_save").bind("click", function() {
		...
		/* var url = "${basePath}/message/pushMessage"; */
		var url = "${basePath}/push/message";
		...
		$.ajax({
			...
			success : function(data) {
				if(data.success){
					...
					alert('职工号：'+data.obj[0].emp+'推送失败!'+'请联系管理员!');
				}
				closeOutWindow();
