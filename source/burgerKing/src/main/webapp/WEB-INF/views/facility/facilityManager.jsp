...
<div class="dzwidth_960 user">
		...
		<tr>
			<td>
				<div class="qjact_btn clearfix">
					<a class="green" id="addFacility"  href="javascript:void(0)"><span>新增</span></a>
			...
			<td>
				<div class="qjstxt_wrap clearfix">
					<input type="text" class="text" name="facilityName" id="facilityName"/>
					<label class="defalut_val" for="facilityName">根据品牌查询</label>
	...
	<table id="gridTableFacility"></table>
		<div id="gridPagerFacility"></div>
</div>
	<script type="text/javascript"
		src="${basePath}/js/facility/facilityManager.js"></script>
	<script type="text/javascript">
	$(function(){
		$("#searchBtn").bind("click",function(){
					$("#gridTableFacility").setGridParam({page:1}).jqGrid().trigger("reloadGrid");
		});
		$("#batchImport").bind('click',function(){
			var url = basePath + "/facility/import";
			tipsWindown("批量导入","url:post?"+url,"660","400","true","","true","");
		})
		$("#downloadTemp").bind('click',function(){
			var url = basePath + "/facility/downloadTemp";
			window.location = url;
		})
	});
</script>
