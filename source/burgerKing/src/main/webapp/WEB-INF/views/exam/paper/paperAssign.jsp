...
<body>
	<table class="addform_wrap">
		<tr>
			<td class="title"><b>*</b>问卷接收者：</td>
			<td style=""><input id="citySel" class="text" type="text"
				readonly="readonly" onclick="showMenu();" name="authNames" /> <input
	...
	<script type="text/javascript">
		...
		$("#btn_save").bind("click", function() {
			...
			var url = "${basePath}/base/paperAssign";
